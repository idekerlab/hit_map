...
# -*- coding: utf-8 -*-
#
# hit_map documentation build configuration file, created by
...
init_file = os.path.join('..', 'hit_map', '__init__.py')
...
latex_documents = [
    (master_doc, 'hit_map.tex',
     u'HIT-MAP Documentation',
     u'Gege Qian', 'manual'),
]
